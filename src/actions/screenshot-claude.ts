  ...
  private async updateDisplay(action: WillAppearEvent["action"]): Promise<void> {
    const svg = `
      <svg xmlns="http://www.w3.org/2000/svg" width="144" height="144" viewBox="0 0 144 144">
        ...
        <text x="72" y="115" font-family="system-ui" font-size="11" fill="#8b5cf6" text-anchor="middle" font-weight="bold">CAPTURE</text>
        <text x="72" y="130" font-family="system-ui" font-size="9" fill="#64748b" text-anchor="middle">Screenshot</text>
      </svg>
    `;
